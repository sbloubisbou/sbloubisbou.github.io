...
![Picture of the Icon.](/favicon.ico)
...
And here is the [settings file](/Readme/settings.cfg) (settings.cfg) mentionned below. It contains every parameters of the program that you can modify to your liking! More info on what the individual parameters do below.
