...
And here is the [settings file](/Resources/settings.cfg) file that contains every parameters of the program that you can modify to your liking! More info on what the parameters do below.
