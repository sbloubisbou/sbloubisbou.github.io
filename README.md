...
To download this program, go to [github.com/sbloubisbou](https://github.com/sbloubisbou/Local-Backup-Creator) and download the *Resources Win_x64* folder. 
The portable .exe file is contained inside and doesn't require any authorizations, simply click, run and read the documentation!
![UI Picture](https://drive.google.com/file/d/1yhspnMMgO3RpirRb_P_jYodqa3wzc1ar/view?usp=sharing)
