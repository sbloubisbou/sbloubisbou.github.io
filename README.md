...
![Picture of the UI of the program.](/Resources/ui_picture.png "Picture of the UI of the program")

#### Before continuing your reading,
Here is the [(un)license](/Resources/(un)license.md) — spoiler, its Public Domain.
...
![Picture of the file metadata setting.](/Resources/compare_file_metadata.png)
...
![Picture of the subfolder section](/Resources/subfolders.png)
...
![Picture of the MTP checkbox](/Resources/enable_mtp.png)
...
![Picture of the log section](/Resources/log_creation.png)
